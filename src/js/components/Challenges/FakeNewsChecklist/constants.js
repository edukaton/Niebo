...
export const form = {
  question: ' Artykuł jest fake newsem. Wiesz o tym najlepiej. Zastanów się, dlaczego inni mogliby go uznać za prawdziwy?',
  options: [
    'Podany jest autor artykułu.',
    'Artykuł jest aktualny.',
    'Obok artykułu znajdują się reklamy',
    'Treść jest poprawna pod kątem językowym.',
    'Artykuł jest napisany zieloną czcionką.',
    'Tekst jest obiektywny - nie zawiera opinii własnych autora artykułu.',
    'Artykuł ukazał się w znanej prasie.',
    'Tytuł artykułu wyolbrzymia/przerysowuje problem opisany w artykule.'
  ]
}
